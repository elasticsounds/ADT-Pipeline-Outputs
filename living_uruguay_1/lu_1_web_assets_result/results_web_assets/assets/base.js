document.addEventListener("DOMContentLoaded", function () {
    ...
    Promise.all([
      ...
      .then(([interfaceHTML, navHTML, activityJS, configHTML]) => {
        ...
        if (sideBarActive) {
          ...
          document.getElementById("content").classList.add("lg:ml-32");
          document.getElementById("content").classList.remove("lg:mx-auto");
        } else {
          sidebar.classList.add("translate-x-full");
          document.getElementById("content").classList.remove("lg:ml-32");
          document.getElementById("content").classList.add("lg:mx-auto");
        }
  ...
  function toggleSidebar() {
    ...
    setCookie("sidebarState", sideBarActive ? "open" : "closed", 7);
